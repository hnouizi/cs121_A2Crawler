...
class Report:
    ...
    def add_url(self, url):
        """Adds a url to the set of unique urls."""
    ...
    def set_frequency(self, text):
        ...
        for word in text:
            ...
            if word in STOP:
                continue
            token = regex.sub('', word.lower()).strip()
    ...
    def write_to_file(self):
        ...
        with open('report.txt', 'w') as report_file:
            print(f"1. number of unique pages: {len(self.unique_urls)}", file=report_file)
    ...
    def print_report(self):
        ...
        print("\n== REPORT ==")
        print(f"number of unique pages: {len(self.unique_urls)}")
        ...
        for i in range(len(sorted_subdomains)):
            ...
            print(f"  {i+1}: {subdomain}, {sorted_subdomains[subdomain]}")
